...
def corr_with_output2(tss_data, nt_data):
# CREATING DATAFRAME:
    ...
    corr_arr = []
    corr_dict = {}
# CALCULATING CORRELATION BETWEEN dependent and independent variables
    for i in x:
        corr, _ = pearsonr(combined_df[i], y)  # for linear collinearity
